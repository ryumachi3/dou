    <footer id="footer" class="p-footer u-bg-dark">
      <nav class="c-fnav p-fnav">
        <ul class="c-fnav__menu p-fnav__menu mb8">
          ...
          <li class="c-fnav__menu02 p-fnav__list"><a class="p-fnav__link" href="<?php echo home_url( '/about' ); ?>">DOUについて</a></li>
          <li class="c-fnav__menu06 p-fnav__list"><a class="p-fnav__link" href="<?php echo home_url( '/privacy' ); ?>">プライバシーポリシー</a></li>
          <li class="c-fnav__menu07 p-fnav__list"><a class="p-fnav__link" href="<?php echo home_url( '/contact' ); ?>">お問い合わせ</a></li>     
        </ul>
