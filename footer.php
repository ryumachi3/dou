    <footer id="footer" class="p-footer <?php echo is_home()?'u-bg':'u-bg-dark'?>">
      <nav class="c-fnav p-fnav">
        <ul class="c-fnav__menu p-fnav__menu mb8">
          ...
          <li class="c-fnav__menu10 p-fnav__list"><a class="p-fnav__link" href="<?php echo home_url( '/diary' ); ?>">日誌ではなく、日記。</a></li>
    ...
    <script type="application/javascript" src="<?php bloginfo('template_url'); ?>/js/main.js?ver=<?php echo filemtime(get_template_directory() . '/js/main.js'); ?>"></script>
    <?php wp_footer(); ?>
  </body>
</html>